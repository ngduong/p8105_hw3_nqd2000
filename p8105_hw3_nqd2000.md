...
(e.g, yogurt, tea, canned jarred vegetables, packaged vegetables fruits,
etc.), <br /> `department`: department name (e.g, produce, dairy eggs,
pantry, etc.), <br /> `product_name`: name of product ordered (e.g,
Serrano Chile Peppers, Organic Dark Chocolate Peanut Butter Cups,
Uncooked Corn Tortillas, Organic Oolong Tea Bags, etc.), <br />
`order_id`: order identifier (observations with the same `order_id`
means products ordered are in a same basket, identified by other
variables as listed next), <br /> `order_dow`: day of week when product
was ordered (e.g, take “0” as Sunday, “1” as Monday, “2” as Tuesday, and
so on), <br /> `order_hour_of_day`: hour of day when product was ordered
(e.g, “1” means 1am, “14” means 2pm, “23” means 11pm, and so on), <br />
